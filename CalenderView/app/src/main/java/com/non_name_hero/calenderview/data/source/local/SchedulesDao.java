...
public interface SchedulesDao {
    @Query("SELECT *, datetime(start_at_datetime, 'unixepoch') as start_timestamp, datetime(end_at_datetime, 'unixepoch') as end_timestamp FROM schedule ORDER BY start_at_datetime, schedule_id")
